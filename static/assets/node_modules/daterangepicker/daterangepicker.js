(function() {
    ...
    u = function() {
        ...
        function t() {}
        return t.allPeriods = ["day", "week", "month", "quarter", "half", "year"], t.scale = function(t) {
        ...
        return e.prototype.extend = function(t) {
            ...
            if (t || (t = this.periods()[0]), "day" !== t && "week" !== t && "month" !== t && "quarter" !== t && "half" !== t && "year" !== t) throw new Error("Invalid period");
        ...
        return t.prototype.calendar = function() {
            ...
            switch (e = this.period.format(), this.period()) {
                ...
                case "half":
                    return a = t.format(e), t = t.clone().startOf("quarter"), n = c.array(t, 6, "month").map(function(t) {
                        return t.format("MMM")
                    }), [{
                        html: a + "<br><span class='months'>" + n.join(", ") + "</span>"
                    }];
