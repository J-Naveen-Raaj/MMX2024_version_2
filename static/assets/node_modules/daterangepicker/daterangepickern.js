...
(function() {
  ...
  Period = (function() {
    ...
    Period.allPeriods = ['day', 'week', 'month', 'quarter', 'half', 'year'];
  ...
  Config = (function() {
    ...
    Config.prototype._period = function(val) {
      ...
      if (val !== 'day' && val !== 'week' && val !== 'month' && val !== 'quarter' && val !== 'half' && val !== 'year') {
  ...
  CalendarView = (function() {
    ...
    CalendarView.prototype.tableValues = function(date) {
      var format, months, quarter, half;
      ...
      switch (this.period()) {
        ...
        case 'half':
          half = date.format(format);
          date = date.clone().startOf('half');
          months = MomentIterator.array(date, 6, 'month').map(function(date) {
            return date.format('MMM');
          });
          return [
            {
              html: half + "<br><span class='months'>" + (months.join(", ")) + "</span>"
            }
          ];
      }
    };
