    ...
    t = function() {
        ...
        function() {
            ...
            return n = function(t, e, n, o, a, i, r) {
                ...
                var a, i;
                return a = document.createElement("canvas"), a.width = 16, a.height = 16, i = a.getContext("2d"), e(i, 0, 2, 16, 14, 2, 1, "#20aa9c", "#1b8e82"), n(i, 2, 1, 3, 3, 1.5, "#1b8e82"), n(i, 11, 1, 3, 3, 1.5, "#1b8e82"), o(i, moment().format("DD"), 8, 12.5, "#146960"), o(i, moment().format("DD"), 8, 11.5, "#fff"), t(a)
            })
        }()
}).call(this);